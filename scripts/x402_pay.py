...
- EIP-3009 (transferWithAuthorization) for USDC — fully implemented
- Solana partial-sign — sign-only via `sign-solana` subcommand
- Permit2 — protocol-defined but not yet implemented (raises NotImplementedError)
